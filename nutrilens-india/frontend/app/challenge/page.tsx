...
export default function ChallengePage() {
    ...
    return (
      <AppShell>
        <div className="max-w-lg mx-auto px-4 py-16 text-center">
          ...
          <h1 className="font-heading text-2xl font-bold text-dark mb-3">Complete Your Audit First</h1>
          <p className="font-body text-dark/60 mb-6">
            The Lifestyle Audit must be completed before you can start the 7-Day Challenge.
          </p>
          <Link href="/audit">
            <Button size="lg">
              Go to Audit
  ...
  const currentDay = Math.min((completedDays.length || 0) + 1, 7);
